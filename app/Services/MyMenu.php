    ...
    public function myMenu(): array
    {
        return [
            ...
            [
                ...
                'is_active' => request()->routeIs('comment*') ? 'active' : '',
                'conditions' => [
                    [
                        'type' => 'or',
                        'condition' => auth()->user()->can('view-any', App\Models\Admin\Comment::class),
                    ],
                    [
                        'type' => 'or',
                        'condition' => auth()->user()->can('create', App\Models\Admin\Comment::class),
                    ],
                ],
                'children' => $this->indexCreateChildren('comment', App\Models\Admin\Comment::class)
            ],
            [
                'type' => 'breaker',
                'name' => 'DEV TOOLS',
